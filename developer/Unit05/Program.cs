...
namespace Unit05
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cast.AddActor("scores", cycle2);


            // create the score
            Score score1 = new Score(cast);
            cast.AddActor("scores", score1);

            Score score2 = new Score(cast);
            cast.AddActor("scores", score2);
